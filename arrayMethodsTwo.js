...
// CODE HERE
let divideTwo = [];
numbers.forEach((e) => divideTwo.push(e / 2));
...
// CODE HERE
let divideTwo2 = numbers.map((e) => e / 2);
...
// CODE HERE
let endsWithI = cities.filter((e) => e.endsWith('i'));
...
// CODE HERE
let totalRicePrice = foods.filter((e) => e.tags.includes('rice')).reduce((acc, curr) => acc + curr.price, 0);
